...
parser.add_argument('--arr', type = str, required = True, help = "Arrival airport codes. Coma separated list. (please check codes on ryanair.com, e.g: GDN,WMI,KRK,POZ)")
...
while(True):
    try:
        ...
        print(CRED + "Unable to download flights. Check internet connection!" + ENDC)
        time.sleep(delay)
        continue
    if r.ok:
